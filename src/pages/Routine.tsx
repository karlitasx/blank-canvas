...
import { Target, Plus, Filter, BarChart3, Sparkles, CalendarDays } from "lucide-react";
...
const Routine = () => {
  ...
  if (!isLoaded) {
    return (
      <DashboardLayout activeNav="/routine">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 animate-fade-in">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Rotina & Hábitos</h1>
        ...
        <Tabs defaultValue="routine" className="w-full">
          <TabsList className="w-full max-w-md mb-6">
            <TabsTrigger value="routine" className="flex-1 gap-2">
              <CalendarDays className="w-4 h-4" />
              Rotina
            </TabsTrigger>
            <TabsTrigger value="habits" className="flex-1 gap-2">
          ...
          {/* === ROTINA TAB === */}
          <TabsContent value="routine" className="animate-fade-in">
            <RoutinePlanner />
          </TabsContent>
                ...
                <div className="glass-card p-4 mb-6 animate-slide-up">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="font-semibold text-foreground">
                      {stats.completedToday}/{stats.totalHabits} — {stats.progressPercent}%
                    </span>
                  </div>
